...
public record EconomyConfig(
    ...
    boolean syncVaultFromDbEnabled,
    List<String> syncVaultFromDbBackendAllowlist,
    int syncVaultFromDbMaxPlayersPerRun,
    long syncVaultFromDbMaxDeltaMinor,
    boolean syncVaultFromDbRequireOnline,
    boolean syncVaultFromDbDryRunDefault,
  ...
  public static EconomyConfig from(ConfigurationSection section) {
    ...
    return new EconomyConfig(
        ...
        section.getBoolean("syncVaultFromDbEnabled", defaults.syncVaultFromDbEnabled()),
        normalizeAllowlist(
            section.getStringList("syncVaultFromDbBackendAllowlist"),
            defaults.syncVaultFromDbBackendAllowlist()),
        Math.max(1, Math.min(100, section.getInt(
            "syncVaultFromDbMaxPlayersPerRun",
            defaults.syncVaultFromDbMaxPlayersPerRun()))),
        Math.max(1, Math.min(10_000_000, section.getLong(
            "syncVaultFromDbMaxDeltaMinor",
            defaults.syncVaultFromDbMaxDeltaMinor()))),
        section.getBoolean("syncVaultFromDbRequireOnline", defaults.syncVaultFromDbRequireOnline()),
        section.getBoolean("syncVaultFromDbDryRunDefault", defaults.syncVaultFromDbDryRunDefault()),
