...
public final class RealCorePlugin extends JavaPlugin {
  ...
  private void mergeBundledConfigDefaults() {
    ...
    boolean missingLobbyDefaults = !getConfig().isConfigurationSection("menus")
        ...
        || !getConfig().contains("halloween.herobrineStalker.appearance.mode")
        || !getConfig().contains("halloween.herobrineStalker.appearance.fallbackToArmorStand")
        || !getConfig().contains("halloween.herobrineStalker.appearance.skinOwner")
        || !getConfig().contains("halloween.herobrineStalker.vanishOnLook.enabled")
        || !getConfig().contains("halloween.herobrineStalker.vanishOnLook.normalViewDegrees")
        || !getConfig().contains("halloween.herobrineStalker.vanishOnLook.miningIntentViewDegrees")
        || !getConfig().contains("halloween.herobrineStalker.vanishOnLook.requireLineOfSight")
        || !getConfig().contains("halloween.herobrineStalker.vanishOnLook.checkIntervalTicks")
        || !getConfig().contains("halloween.herobrineStalker.proximityEffect.enabled")
        || !getConfig().contains("halloween.herobrineStalker.proximityEffect.radius")
        || !getConfig().contains("halloween.herobrineStalker.proximityEffect.requiredSeconds")
        || !getConfig().contains("halloween.herobrineStalker.proximityEffect.effect")
        || !getConfig().contains("halloween.herobrineStalker.proximityEffect.durationSeconds")
        || !getConfig().contains("halloween.herobrineStalker.proximityEffect.amplifier")
        || !getConfig().contains("halloween.herobrineStalker.proximityEffect.cooldownSeconds")
        || !getConfig().contains("halloween.herobrineStalker.proximityEffect.vanishAfterApply")
        ...
        || !getConfig().contains("halloween.herobrineStalker.distantFootsteps.enabled")
        || !getConfig().contains("halloween.herobrineStalker.miningFakeout.enabled")
        || !getConfig().contains("halloween.herobrineStalker.distantSilhouette.enabled")
        || !getConfig().contains("halloween.herobrineStalker.omenMarker.enabled")
        || !getConfig().contains("halloween.herobrineStalker.lookAwayUnease.enabled")
