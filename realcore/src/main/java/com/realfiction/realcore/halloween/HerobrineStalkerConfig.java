...
public record HerobrineStalkerConfig(
    ...
    HerobrineMiningFakeoutConfig miningFakeout,
    HerobrineDistantSilhouetteConfig distantSilhouette,
    HerobrineOmenMarkerConfig omenMarker,
    HerobrineWindowStalkConfig windowStalk,
    HerobrineDistantOmenStructureConfig distantOmenStructure,
    HerobrineLookAwayUneaseConfig lookAwayUnease,
  ...
  public static HerobrineStalkerConfig from(ConfigurationSection section) {
    ...
    return new HerobrineStalkerConfig(
        ...
        HerobrineMiningFakeoutConfig.from(section.getConfigurationSection("miningFakeout")),
        HerobrineDistantSilhouetteConfig.from(section.getConfigurationSection("distantSilhouette")),
        HerobrineOmenMarkerConfig.from(section.getConfigurationSection("omenMarker")),
        HerobrineWindowStalkConfig.from(section.getConfigurationSection("windowStalk")),
        HerobrineDistantOmenStructureConfig.from(section.getConfigurationSection("distantOmenStructure")),
  ...
  public static HerobrineStalkerConfig defaults() {
    return new HerobrineStalkerConfig(
        ...
        HerobrineMiningFakeoutConfig.defaults(),
        HerobrineDistantSilhouetteConfig.defaults(),
        HerobrineOmenMarkerConfig.defaults(),
        HerobrineWindowStalkConfig.defaults(),
        HerobrineDistantOmenStructureConfig.defaults(),
